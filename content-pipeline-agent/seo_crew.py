...
class SeoCrew:
    ...
    def seo_expert(self):
        return Agent(
            role="SEO Specialist",
            goal="Analyze blog posts for SEO optimization and provide a score with detailed reasoning. Be demanding, don't give underserved good scores.",
            backstory="""
    ...
    def seo_audit(self):
        return Task(
            ...
            expected_output="""
                A Score object with:
                    - score: integer from 0-10 rating the SEO quaility
